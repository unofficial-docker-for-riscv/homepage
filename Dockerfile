...
FROM ghcr.io/unofficial-docker-for-riscv/baseimage-node:lts-alpine AS deps
...
FROM ghcr.io/unofficial-docker-for-riscv/baseimage-node:lts-alpine AS builder
WORKDIR /app
...
FROM ghcr.io/unofficial-docker-for-riscv/baseimage-node:lts-alpine AS runner
